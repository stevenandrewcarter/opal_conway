...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_reader', '$attr_accessor', '$canvas_id', '$canvas', '$floor', '$/', '$height', '$width', '$blank_state', '$draw_canvas', '$add_mouse_event_listener', '$add_demo_event_listener', '$>=', '$context', '$+', '$new', '$each', '$[]=', '$max_y', '$max_x', '$==', '$fill_cell', '$[]', '$state', '$page_x', '$page_y', '$Document', '$e', '$scrollLeft', '$documentElement', '$scrollTop', '$body', '$-', '$*', '$on', '$get_cursor_position', '$x', '$y', '$<<', '$seed', '$find', '$unfill_cell', '$delete', '$ctrl_d_pressed?', '$ctrl_key', '$which']);
  (function($base, $super) {
    function $Grid(){};
    ...
    def.$initialize = function() {
      ...
      self.max_y = (self.$width()['$/']((($a = $scope.CELL_WIDTH) == null ? $opal.cm('CELL_WIDTH') : $a))).$floor();
    ...
    def.$blank_state = function() {
      var $a, $b, TMP_1, self = this, h = nil;

      h = (($a = $scope.Hash) == null ? $opal.cm('Hash') : $a).$new();
      ($a = ($b = ($range(0, self.$max_x(), false))).$each, $a._p = (TMP_1 = function(x){var self = TMP_1._s || this, $a, $b, TMP_2;
if (x == null) x = nil;
      return ($a = ($b = ($range(0, self.$max_y(), false))).$each, $a._p = (TMP_2 = function(y){var self = TMP_2._s || this;
if (y == null) y = nil;
        return h['$[]=']([x, y], 0)}, TMP_2._s = self, TMP_2), $a).call($b)}, TMP_1._s = self, TMP_1), $a).call($b);
      return h;
    };

    def.$redraw_canvas = function() {
      var $a, $b, TMP_3, self = this;

      self.$draw_canvas();
      return ($a = ($b = self.$state()).$each, $a._p = (TMP_3 = function(cell, liveness){var self = TMP_3._s || this;
if (cell == null) cell = nil;if (liveness == null) liveness = nil;
    ...
    def.$add_mouse_event_listener = function() {
      var $a, $b, TMP_4, $c, TMP_5, $d, self = this;

      ($a = ($b = (($c = $scope.Element) == null ? $opal.cm('Element') : $c).$find("#" + (self.$canvas_id()))).$on, $a._p = (TMP_4 = function(event){var self = TMP_4._s || this, $a, coords = nil, x = nil, y = nil;
if (event == null) event = nil;
      coords = self.$get_cursor_position(event);
        $a = [coords.$x(), coords.$y()], x = $a[0], y = $a[1];
        self.$fill_cell(x, y);
        return self.$seed()['$<<']([x, y]);}, TMP_4._s = self, TMP_4), $a).call($b, "click");
      return ($a = ($c = (($d = $scope.Element) == null ? $opal.cm('Element') : $d).$find("#" + (self.$canvas_id()))).$on, $a._p = (TMP_5 = function(event){var self = TMP_5._s || this, $a, coords = nil, x = nil, y = nil;
if (event == null) event = nil;
      coords = self.$get_cursor_position(event);
        $a = [coords.$x(), coords.$y()], x = $a[0], y = $a[1];
        self.$unfill_cell(x, y);
        return self.$seed().$delete([x, y]);}, TMP_5._s = self, TMP_5), $a).call($c, "dblclick");
    };

    def.$add_demo_event_listener = function() {
      var $a, $b, TMP_6, $c, self = this;

      return ($a = ($b = (($c = $scope.Document) == null ? $opal.cm('Document') : $c)).$on, $a._p = (TMP_6 = function(event){var self = TMP_6._s || this, $a, $b, TMP_7;
if (event == null) event = nil;
      if ((($a = self['$ctrl_d_pressed?'](event)) !== nil && (!$a._isBoolean || $a == true))) {
          return ($a = ($b = [[25, 1], [23, 2], [25, 2], [13, 3], [14, 3], [21, 3], [22, 3], [12, 4], [16, 4], [21, 4], [22, 4], [35, 4], [36, 4], [1, 5], [2, 5], [11, 5], [17, 5], [21, 5], [22, 5], [35, 5], [36, 5], [1, 6], [2, 6], [11, 6], [15, 6], [17, 6], [18, 6], [23, 6], [25, 6], [11, 7], [17, 7], [25, 7], [12, 8], [16, 8], [13, 9], [14, 9]]).$each, $a._p = (TMP_7 = function(x, y){var self = TMP_7._s || this;
if (x == null) x = nil;if (y == null) y = nil;
          self.$fill_cell(x, y);
            return self.$seed()['$<<']([x, y]);}, TMP_7._s = self, TMP_7), $a).call($b)
          } else {
          return nil
        }}, TMP_6._s = self, TMP_6), $a).call($b, "keypress");
    };

    return (def['$ctrl_d_pressed?'] = function(event) {
      var $a, self = this;

      return (($a = event.$ctrl_key()['$=='](true)) ? event.$which()['$=='](4) : $a);
    }, nil) && 'ctrl_d_pressed?';
  })(self, null);
  return (function($base, $super) {
...
//# sourceMappingURL=/__opal_source_maps__/grid.js.map
;
/* Generated by Opal 0.6.1 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  ...
  return (function($base, $super) {
    ...
    def.interval = nil;
    def.$initialize = TMP_1 = function(time) {
      var self = this, $iter = TMP_1._p, block = $iter || nil;
...
//# sourceMappingURL=/__opal_source_maps__/interval.js.map
;
/* Generated by Opal 0.6.1 */
(function($opal) {
  var $a, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, game = nil;

  $opal.add_stubs(['$attr_reader', '$extend', '$add_enter_event_listener', '$def_delegators', '$on', '$each', '$[]=', '$state', '$seed', '$enter_pressed?', '$run', '$==', '$which', '$new', '$tick', '$state=', '$new_state', '$redraw_canvas', '$get_state_at', '$[]', '$is_underpopulated?', '$is_living_happily?', '$is_overpopulated?', '$can_reproduce?', '$is_alive?', '$<', '$population_at', '$include?', '$>', '$is_dead?', '$reduce', '$map', '$to_proc', '$-', '$+', '$!']);
  ;
  ;
  ;
  ;
  ...
  (function($base, $super) {
    function $Conway(){};
    var self = $Conway = $klass($base, $super, 'Conway', $Conway);
    ...
    def.$add_enter_event_listener = function() {
      var $a, $b, TMP_1, $c, self = this;

      return ($a = ($b = (($c = $scope.Document) == null ? $opal.cm('Document') : $c)).$on, $a._p = (TMP_1 = function(event){var self = TMP_1._s || this, $a, $b, TMP_2;
if (event == null) event = nil;
      ($a = ($b = self.$seed()).$each, $a._p = (TMP_2 = function(x, y){var self = TMP_2._s || this;
if (x == null) x = nil;if (y == null) y = nil;
        return self.$state()['$[]=']([x, y], 1)}, TMP_2._s = self, TMP_2), $a).call($b);
        if ((($a = self['$enter_pressed?'](event)) !== nil && (!$a._isBoolean || $a == true))) {
          return self.$run()
          } else {
          return nil
        };}, TMP_1._s = self, TMP_1), $a).call($b, "keypress");
    };

    def['$enter_pressed?'] = function(event) {
      var self = this;
    ...
    def.$run = function() {
      ...
      return ($a = ($b = (($c = $scope.Interval) == null ? $opal.cm('Interval') : $c)).$new, $a._p = (TMP_3 = function(){var self = TMP_3._s || this;

      return self.$tick()}, TMP_3._s = self, TMP_3), $a).call($b);
    };
    ...
    def.$new_state = function() {
      var $a, $b, TMP_4, self = this, new_state = nil;

      new_state = (($a = $scope.Hash) == null ? $opal.cm('Hash') : $a).$new();
      ($a = ($b = self.$state()).$each, $a._p = (TMP_4 = function(cell, _){var self = TMP_4._s || this;
if (cell == null) cell = nil;if (_ == null) _ = nil;
      return new_state['$[]='](cell, self.$get_state_at(cell['$[]'](0), cell['$[]'](1)))}, TMP_4._s = self, TMP_4), $a).call($b);
      return new_state;
    };

    def.$get_state_at = function(x, y) {
      var $a, self = this;

      if ((($a = self['$is_underpopulated?'](x, y)) !== nil && (!$a._isBoolean || $a == true))) {
        return 0
      } else if ((($a = self['$is_living_happily?'](x, y)) !== nil && (!$a._isBoolean || $a == true))) {
        return 1
      } else if ((($a = self['$is_overpopulated?'](x, y)) !== nil && (!$a._isBoolean || $a == true))) {
        return 0
      } else if ((($a = self['$can_reproduce?'](x, y)) !== nil && (!$a._isBoolean || $a == true))) {
        return 1
        } else {
        return nil
      };
    ...
    def['$is_underpopulated?'] = function(state, x, y) {
      var $a, self = this;

      return ($a = self['$is_alive?'](x, y), $a !== false && $a !== nil ?self.$population_at(x, y)['$<'](2) : $a);
    };

    def['$is_living_happily?'] = function(x, y) {
      var $a, self = this;

      return ($a = self['$is_alive?'](x, y), $a !== false && $a !== nil ?([2, 3]['$include?'](self.$population_at(x, y))) : $a);
    };

    def['$is_overpopulated?'] = function(x, y) {
      var $a, self = this;

      return ($a = self['$is_alive?'](x, y), $a !== false && $a !== nil ?self.$population_at(x, y)['$>'](3) : $a);
    };

    def['$can_reproduce?'] = function(x, y) {
      var $a, self = this;

      return ($a = self['$is_dead?'](x, y), $a !== false && $a !== nil ?self.$population_at(x, y)['$=='](3) : $a);
    };

    def.$population_at = function(x, y) {
      var $a, $b, self = this;

      return ($a = ($b = [self.$state()['$[]']([x['$-'](1), y['$-'](1)]), self.$state()['$[]']([x['$-'](1), y]), self.$state()['$[]']([x['$-'](1), y['$+'](1)]), self.$state()['$[]']([x, y['$-'](1)]), self.$state()['$[]']([x, y['$+'](1)]), self.$state()['$[]']([x['$+'](1), y['$-'](1)]), self.$state()['$[]']([x['$+'](1), y]), self.$state()['$[]']([x['$+'](1), y['$+'](1)])]).$map, $a._p = "to_i".$to_proc(), $a).call($b).$reduce("+");
    };

    def['$is_alive?'] = function(x, y) {
      var self = this;

      return self.$state()['$[]']([x, y])['$=='](1);
    };

    return (def['$is_dead?'] = function(x, y) {
      var self = this;

      return self['$is_alive?'](x, y)['$!']();
    }, nil) && 'is_dead?';
  })(self, null);
  return game = (($a = $scope.Conway) == null ? $opal.cm('Conway') : $a).$new((($a = $scope.Grid) == null ? $opal.cm('Grid') : $a).$new());
})(Opal);
